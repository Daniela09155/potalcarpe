        ...
        <div class="col-md-8 mt-3">
            <div class="card">
                ...
                <div class="card-header">
                    <h2>{!! $role->name !!} detalles</h2>
                </div>


                <div class="card-body">
                    <div class="form-group">
                        <input type="text" class="form-control" id="name" name="name" placeholder="nombre" value="{!! old('name',$role->name) !!}" required disabled>
                    </div>


                    <div class="form-group">
                        <input type="text" class="form-control" id="slug" name="slug" placeholder="identificador" value="{!! old('slug',$role->slug) !!}" required disabled>
                    </div>


                    <div class="form-group">
                        <textarea name="description" id="description" class="form-control" placeholder="desacripcion" disabled>{!! old('description',$role->description) !!}</textarea>
                    </div>

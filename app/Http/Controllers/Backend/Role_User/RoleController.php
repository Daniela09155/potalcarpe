...
class RoleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('role_user.role.index', compact('roles'))->with('status_success', 'Rol actualizado correctamente');//Role updated successfully
    }
    ...
    public function store(RoleStoreRequest $request)
    {
        ...
        return redirect()->route('role.index')->with('status_success', 'Rol actualizado correctamente');//Role updated successfully
    }
